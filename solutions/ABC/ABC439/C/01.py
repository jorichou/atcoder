...
if __name__ == "__main__": # メイン処理
    ...
    sorted_good_numbers = list(sorted([k for k, v in good_numbers.items() if v == 1]))

    # sorted_good_numbers = list(sorted(list(good_numbers)))
    print(len(sorted_good_numbers))
    print(*sorted_good_numbers, sep=' ')